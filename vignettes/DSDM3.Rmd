...
#   labs(x = "Observation", y = "Taxa", title = "Simulated data with two clusters")
# 
# ### 4 Clusters
...
#         axis.ticks = element_blank(),
#         plot.title = element_text(hjust = 0.5)) +
#   labs(x = "Observation", y = "Taxa", title = "Simulated data with four clusters")
# 
...
We obtain the final cluster assignment by using `finalCLUS()` function. In Table 2, we compare the cluster assignment to the observed sexual behavior and HIV infection status. We observed that the dominant bacteria in each resulting cluster aligns with the findings discussed in @noguera2016gut.
